...
- **High-performance computing:** parallelized with MPI and OpenMP, built on optimized libraries (FFTW, ScaLAPACK), and able to take advantage of GPU acceleration on NVIDIA hardware.
